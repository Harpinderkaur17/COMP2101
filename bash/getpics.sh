...
#Task-1 Download file Picture.tgz if not present
...
#Task-1 If the file is present then extract it and remove file
test -f ~/Pictures/pics.tgz && tar -C ~/Pictures -zxvf ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
