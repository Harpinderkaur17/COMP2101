...
# Trap for int signals
trap maxCount SIGINT
# Trap for quit signals
trap quit SIGQUIT
...
# This function will maximise the sleep count
function maxCount {
echo " Interrupt is not allowed"
sleepCount=$numberOfSleeps
doCountdown | dialog --gauge "Remaining Time" 7 60
stty sane
}

# This function will exit from script
function quit {
echo " You found a Secret to interrupt and exit"
stty sane
exit 0
}
